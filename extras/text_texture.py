...
class TextTexture(Texture):
    ...
    def __init__(self, text="Hello, world!",
                 system_font_name=None, font_file_name="../../assets/VeniteAdoremus-rgRBA.ttf",
        ...
        super().__init__()
        # default font
        font = pygame.font.SysFont(system_font_name, font_size) if font_file_name is None else pygame.font.Font(font_file_name, font_size)
